...
def main():
    ...
    try:
        experiment_cfg = load_cfg_from_registry(args_cli.task, "skrl_sppo_cfg_entry_point")
    except ValueError:
        experiment_cfg = load_cfg_from_registry(args_cli.task, "skrl_cfg_entry_point")

    # specify directory for logging experiments (load checkpoint)
    log_root_path = os.path.join("logs", "skrl", experiment_cfg["experiment"]["directory"])
    ...
    agent_cfg = load_cfg_from_registry(args_cli.task, "skrl_sppo_cfg_entry_point")
