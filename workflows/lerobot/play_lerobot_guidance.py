...
def get_surgery_policy_input(obs):
    ...
    image = image.reshape(num_envs, 5, 5, 50, 37)
    image = image.permute(0, 2, 3, 1, 4)
    image = image.reshape(num_envs, 5 * 50, 37 * 5)
...
def main(cfg: EvalPipelineConfig):
    ...
    dataset_meta = LeRobotDatasetMetadata(repo_id="yunkao/us-guidance",
                                          root="/home/yunkao/git/IsaacLabExtensionTemplate/lerobot-dataset/Isaac-robot-US-guidance-v0")
    # Create the policy
    print(cfg.policy)
